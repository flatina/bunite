...
import { attachNavigationChecks, checkIPC, setupServer } from "./ipc";
import { checkWindow, runWindowTests } from "./window";
...
const win = new BrowserWindow({
  ...
  navigationRules: [
    "^*",
    "appres://app.internal/smoke/*",
    "^appres://app.internal/smoke/nav-blocked.html*",
  ],
});
